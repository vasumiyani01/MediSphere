...
let patientList = JSON.parse(localStorage.getItem('doctor_patients')) || [
    { id: 1, name: "Robert Chen", gender: "Male", age: 45, reason: "Heart checkup followup", city: "Boston", mobile_number: "617-555-0199" },
    { id: 2, name: "Emily Johnson", gender: "Female", age: 29, reason: "General consultation", city: "New York", mobile_number: "212-555-0143" },
    { id: 3, name: "Alice Brown", gender: "Female", age: 34, reason: "Thyroid screening", city: "Boston", mobile_number: "617-555-0122" },
    { id: 4, name: "David Miller", gender: "Male", age: 52, reason: "Diabetes review", city: "Chicago", mobile_number: "312-555-0177" },
    { id: 5, name: "Sophia Martinez", gender: "Female", age: 23, reason: "Skin allergy", city: "Houston", mobile_number: "713-555-0188" }
];
...
function renderPatientsTable(list) {
    ...
    if (list.length === 0) {
        tbody.innerHTML = `<tr><td colspan="8" style="text-align: center; color: var(--text-secondary); padding: 20px;">No patients found matching your search.</td></tr>`;
        return;
    }
    ...
    if (patientForm) {
        patientForm.addEventListener('submit', function(e) {
            ...
            if (id) {
                ...
                if (idx !== -1) {
                    patientList[idx] = { id: parseInt(id), name, gender, age, reason, city, mobile_number };
                }
            } else {
                const nextId = patientList.length > 0 ? Math.max(...patientList.map(x => x.id)) + 1 : 1;
                patientList.push({ id: nextId, name, gender, age, reason, city, mobile_number });
            }
