...
<head>
    ...
    <title>MediSphere | AI-Powered Smart Healthcare Ecosystem</title>
    ...
    <!-- React, ReactDOM, and Babel Standalone CDNs -->
    <script src="https://unpkg.com/react@18/umd/react.production.min.js" crossorigin></script>
    <script src="https://unpkg.com/react-dom@18/umd/react-dom.production.min.js" crossorigin></script>
    <script src="https://unpkg.com/@babel/standalone/babel.min.js"></script>

    <!-- Embedded CSS Styling System (Midnight Black-Blue theme) -->
    <style>
        :root {
            ...
            /* Color Theme Variables (Light Mode Only) */
            --bg-primary: #f8fafc;
            --bg-secondary: #ffffff;
            --bg-tertiary: #f1f5f9;
        ...
        * {
        ...
        .card:hover {
            ...
            box-shadow: var(--hover-glow, var(--shadow-glow));
        }
        ...
        .hero-banner:hover {
            ...
            box-shadow: 0 0 25px rgba(37, 99, 235, 0.15) !important;
        }
        ...
        /* Theme-colored scrollbars for explore sliders */
        .theme-slider::-webkit-scrollbar {
            height: 8px;
        }

        .theme-slider::-webkit-scrollbar-track {
        ...
        .theme-slider::-webkit-scrollbar-thumb:hover {
...
<body>
    ...
    <!-- React Application Component Scripts -->
    {% verbatim %}
    <script type="text/babel">
            ...
            return (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
                    ...
                    <ExploreSection id="pharmacies" title="Pharmacies" color="#f59e0b" openLogin={openLogin}>
                        <PharmaciesSection isSlider={true} themeColor="#f59e0b" pincode={pincode} globalSearch={globalSearch} />
                    </ExploreSection>

                    <ExploreSection id="doctors" title="Doctors" color="#10b981" openLogin={openLogin}>
                        <DoctorsSection isSlider={true} themeColor="#10b981" pincode={pincode} globalSearch={globalSearch} />
                    </ExploreSection>
        ...
        function PharmaciesSection({ isSlider, themeColor, pincode, globalSearch }) {
                                ...
                                return (
                                    <div key={p.id} className="card" style={{
                                        ...
                                        <div style={{ display: 'flex', gap: '10px', borderTop: '1px solid var(--border-color)', paddingTop: '16px' }}>
                                            <a href={`tel:${p.mobile_number || p.phone}`} className="btn btn-secondary" style={{ flex: 1, textDecoration: 'none', textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>Call</a>
                                            <button onClick={() => alert(`Showing directions to ${p.name}`)} className="btn" style={{ flex: 1, backgroundColor: themeColor || 'var(--color-primary)', color: '#fff' }}><ExternalLinkIcon />Directions</button>
                                        </div>
                                    </div>
                                );
                            })
        ...
        function DoctorsSection({ isSlider, themeColor, pincode, globalSearch }) {
                            ...
                            displayList.map(d => {
                                ...
                                return (
                                    <div key={d.id} className="card" style={{
                                        ...
                                        <button onClick={() => alert(`Booking consultation with Dr. ${d.name}`)} className="btn" style={{ width: '100%', gap: '8px', backgroundColor: themeColor || 'var(--color-primary)', color: '#fff' }}>
                                ...
                                return (
                                    <div key={d.id} className="card" style={{
                                        ...
                                        <div style={{ display: 'flex', gap: '8px', borderTop: '1px solid var(--border-color)', paddingTop: '16px', marginTop: 'auto' }}>
                                            <button onClick={() => { if (onNavigate) onNavigate('medicines'); else alert("Locating medicines & pharmacies..."); }} className="btn" style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '4px', fontSize: '11px', padding: '8px 4px', backgroundColor: '#3b82f6', color: '#fff', border: 'none', borderRadius: '8px', fontWeight: 600, cursor: 'pointer' }}>
                                                <MapPinIcon size={12} /><span>Locate</span>
                                            </button>
                                            <button onClick={() => { if (onNavigate) onNavigate('doctors'); else alert("Consulting doctors..."); }} className="btn" style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '4px', fontSize: '11px', padding: '8px 4px', backgroundColor: '#10b981', color: '#fff', border: 'none', borderRadius: '8px', fontWeight: 600, cursor: 'pointer' }}>
                                                <UsersIcon size={12} /><span>Doctor</span>
                                            </button>
                                        </div>
                                    </div>
                                );
        ...
        function App() {
            ...
            const getDashboardUrl = (userType) => {
                if (userType === 'citizen') return '/citizens/';
                if (userType === 'doctor') return '/doctors/';
                if (userType === 'pharmacy') return '/pharmacies/';
                return '/';
            };
            ...
            useEffect(() => {
                ...
                // Fetch public stats counts on mount
            ...
            const handleLoginSuccess = (userData) => {
                setUser(userData);
                window.location.href = getDashboardUrl(userData.user_type);
            };
