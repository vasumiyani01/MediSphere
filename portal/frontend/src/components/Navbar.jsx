...
function Navbar({ activeTab, setActiveTab, theme, toggleTheme, openLogin, scrollToSection, pincode, openPincode }) {
  ...
  const navItems = [
    ...
    { id: 'clinics', label: 'Clinics', sectionId: 'section-clinics' },
      ...
      <div className="desktop-controls" style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
        ...
        <button
          ...
          style={{
            ...
            padding: '0 20px',
            borderRadius: '10px',
            boxShadow: theme === 'dark' ? '0 0 15px rgba(59, 130, 246, 0.25)' : 'none'
          }}
        >
          <LogIn size={16} />
          <span>Login</span>
