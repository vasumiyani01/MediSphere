...
function HomeSection({ onNavigate, openLogin }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
      ...
      {/* Explore Medicines */}
      <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginTop: '10px', paddingTop: '10px' }}>
      ...
      {/* Explore Diseases */}
      <div id="section-diseases" style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginTop: '15px', scrollMarginTop: '90px', paddingTop: '10px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
      ...
      {/* Explore Pharmacies */}
      <div id="section-pharmacies" style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginTop: '15px', scrollMarginTop: '90px', paddingTop: '10px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
      ...
      {/* Explore Doctors */}
      <div id="section-doctors" style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginTop: '15px', scrollMarginTop: '90px', paddingTop: '10px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
