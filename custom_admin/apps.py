    ...
    def ready(self):
        ...
        try:
            ...
            try:
                ...
                # 1. portal/templates/portal/index.html -> portal/templates/portal/index.jsx
                src = os.path.join(base, 'portal', 'templates', 'portal', 'index.html')
                dst = os.path.join(base, 'portal', 'templates', 'portal', 'index.jsx')
                if os.path.exists(src):
                    shutil.copy2(src, dst)
                    os.remove(src)
                    print("Converted index.html to index.jsx")
